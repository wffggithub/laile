...
<div class="middlle p-r mt60 article_sb_type">
	...
	<div class="w1200 clearfix">
		...
		<div class="fl w244">
			...
			<ul style="margin-bottom: 62px;">
				<?php if(is_array($all)): $i = 0; $__LIST__ = $all;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li id="c_8"><a href="<?php echo U('index',array('id'=>$v['id']));?>"><span class="en"><?php echo ($v["name"]); ?></span></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
			</ul>

		</div>

		<div class="fr w911 sb_type">
...
<input type="hidden" value="6" id="ddid"/>
<script>
    $(document).ready(function(){
        var ccid=$("#ddid").val();
        $("#d_"+ccid).addClass("cur");
    });
