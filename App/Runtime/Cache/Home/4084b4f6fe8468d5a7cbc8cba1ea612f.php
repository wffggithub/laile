...
<div class="middlle p-r mt60 list_article_type">
	...
	<div class="w1200">
		...
		<div class="">
			...
			<ul>
				<?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li class="clearfix mb60">

					<div class="img fl">

						<img src="<?php echo ($v["image_path"]); ?>" alt="" />
					...
					<div class="txt fr">
						...
						<div class="clearfix">
							...
							<a href="<?php echo U('detail',array('id'=>$v['id']));?>" class="a1">
		...
		<?php echo ($page); ?> 共 <?php echo ($count); ?> 条
