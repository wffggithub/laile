                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <div class="col-xs-10 col-sm-5">
                                        <?php echo UpImage("water_image_path",100,100,$water['v'],'Setting');?>
                                    </div>
                                    <span class="help-inline col-xs-12 col-sm-7">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    ...
                                    <div class="col-sm-1" style="margin-top: 5px;">
                                        <input type="radio" name="position" class="is_hot" value="0" <?php if($position['v'] == 0): ?>checked="checked"<?php endif; ?>
                                        >
                                    </div>
                                    ...
                                    <div class="col-sm-5" style="margin-top: 5px;">
                                        <input type="radio" name="position" class="is_hot" value="1" <?php if($position['v'] == 1): ?>checked="checked"<?php endif; ?>
                                        >
